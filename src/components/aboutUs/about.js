      ...
      <div className="about-us">
        ...
        <div data-aos="fade-down" className="image-section">
          ...
          <p className="text">
            ...
            dairy farming, and renewable energy production. Our Vision: To be
            the largest commercial agricultural firm in Africa, to ensure zero
            Hunger by lessening the cost of food products to better serve
